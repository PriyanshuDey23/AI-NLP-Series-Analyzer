...
class CharacterChatBot():
    ...
    def __init__(self,
                 model_path,
                 data_path="/content/AI-NLP-Series-Analyzer/Data/naruto.csv", # Csv PAth
    ...
    def chat(self, message, history):
        ...
        # If the model ouput can terminate the generation
        terminator = [
    ...
    def train(self,
              ...
              dataset,
              output_dir = "./results", # Save weights
        ...
        # BitsAndBytesConfig :- This replaces load_in_8bit or load_in_4bittherefore both options are mutually exclusive., So that we can load the model
        bnb_config = BitsAndBytesConfig(
            load_in_4bit=True,
            bnb_4bit_quant_type="nf4",
            bnb_4bit_compute_dtype=torch.float16,
        ...
        # LORA :- is a way to adapt a large machine learning model for specific uses without retraining the entire model.
        ...
        # Flush memory(delete the memory)
        del trainer, model
        gc.collect()
    ...
    def load_data(self):
        ...
        return dataset # Hugging face dataset
